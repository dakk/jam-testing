...
describe("getTargetConfig", () => {
  ...
  it("parses env vars correctly", () => {
    ...
    process.env.TARGET_CMD_CONFORMANCE = "fuzz --conformance {TARGET_SOCK}";
    ...
    assert.strictEqual(config.cmdConformance, "fuzz --conformance {TARGET_SOCK}");
